 ...
 * relevant to cars.
 */
public class CarJdk21 extends Vehicle {
   ...
   * <p>
   * Validation of numberOfSeats and numberOfDoors can only occur
   * after calling the superclass constructor, which would be unnecessary
   ...
   */
  public CarJdk21(String name, BigDecimal price, int numberOfSeats, int numberOfDoors) {
    super(name, price);
    if (numberOfSeats < 1) {
